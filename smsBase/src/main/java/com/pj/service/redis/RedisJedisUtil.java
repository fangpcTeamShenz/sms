...
public class RedisJedisUtil {  
    ...
    private static final Logger LOGGER = Logger.getLogger(RedisJedisUtil.class);
    private static JedisPool pool = null;  
    
    private static RedisJedisUtil ru = new RedisJedisUtil();  
     
    private RedisJedisUtil() {  
    	
        if (pool == null) {  
            String ip = "192.168.116.207";  
            int port = 5379;  
    ...
    public static RedisJedisUtil getRu() {  
        return ru;  
    }  
  
    public static void setRu(RedisJedisUtil ru) {  
        RedisJedisUtil.ru = ru;  
    }  
}  