...
<div class="widget-box position-relative">
	<div class="widget-header">
		...
		<div class="widget-toolbar no-border">
			<button class="btn btn-xs btn-success bigger event-dialog" data-url="${ctx}/charge/admin/add">
		...
		<div class="widget-toolbox padding-8 clearfix">
			<form class="form-inline">
				...
				<button type="button" class="btn btn-info btn-sm event-search" 
					data-url="${ctx}/charge/admin/page/list" data-tpl="tpl-charge">
...
<jsp:include page="/WEB-INF/views/common/admin_footer.jsp" flush="true">
	<jsp:param value="menu-charge-list" name="menu"/>
</jsp:include>

<script id="tpl-charge" type="text/html">
	{{# for(var i = 0; i < d.length; i++){ }}
      <tr>
        ...
        <td>
			{{# if(d[i].status != 2) { }}
				<shiro:hasPermission name="charge_edit">
            		<button type="button" class="btn btn-xs btn-yellow event-dialog" data-url="${ctx}/charge/admin/edit/{{=d[i].id}}">
