...
<form class="form-horizontal" action="${ctx}/routeForce/admin/insert" method="post">
	...
	<div class="form-group">
		...
		<div class="col-xs-12 col-sm-5 no-padding-right">
			<span class="block input-icon input-icon-right">
				<input type="text" name="routeName" autocomplete="off" class="width-100" required="required"/>
			</span>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-xs-12 col-sm-5 no-padding-right">
			<span class="block input-icon input-icon-right">
				<input type="number" id="priority" name="priority" autocomplete="off" class="width-100" />
			</span>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-xs-12 col-sm-5 no-padding-right">
			<span class="block input-icon input-icon-right">
				<app:propertySelect parentPath="business.routeForce.useable" placeholder="--是否可用--" name="useable" required="true"/>
			</span>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-xs-12 col-sm-5 no-padding-right">
			<span class="block input-icon input-icon-right">
				<input type="number" id="rate" name="rate" autocomplete="off" class="width-100" />
			</span>
		</div>
	</div>
