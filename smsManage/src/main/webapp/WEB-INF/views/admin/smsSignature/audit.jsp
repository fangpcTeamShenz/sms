...
<form class="form-horizontal" action="${ctx}/smsSignature/admin/editAudit" method="post">
	...
	<%-- <div class="form-group">
		<label class="control-label col-xs-12 col-sm-3 col-md-3 no-padding-right">签名状态</label>

		<div class="col-xs-12 col-sm-5 no-padding-right">
			<span class="block input-icon input-icon-right">
				<app:propertySelect parentPath="business.smsSignature.status" placeholder="--签名状态--" propertyKey="${item.status }" name="status" required="true"/>
			</span>
		</div>
	</div> --%>
